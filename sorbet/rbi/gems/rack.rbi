...
class Rack::Directory::DirectoryBody < Anonymous_Struct_12
...
class Rack::Multipart::Parser::Collector::MimePart < Anonymous_Struct_13
  def get_data; end
end
...
class Rack::Session::Cookie::SessionId < Anonymous_Delegator_14
  def cookie_value; end
